...
# COMMUNICATION FLOW
Orchestrator -> Emite Diretiva -> Architect Agents
Architect Agents -> Retornam Specs -> Orchestrator Valida
Orchestrator -> Libera para -> Execution Agents
QA Master -> Envia Bug -> Orchestrator -> Pede Correção ao Architect.
