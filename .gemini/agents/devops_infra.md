---
name: devops_infra
description: Engenheiro de DevOps e SRE. Especialista em Docker, Kubernetes, CI/CD e infraestrutura elástica. Use-o para deploys, monitoramento, containers e automação de pipeline.
kind: local
tools:
  - "*"
model: inherit
