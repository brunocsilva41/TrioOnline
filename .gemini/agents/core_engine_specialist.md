---
name: core_engine_specialist
description: Especialista em Game Engine e Determinismo. Responsável pela lógica de jogo compartilhada, TurnStateMachine e garantia de que as 5 Leis Determinísticas sejam seguidas. Use-o para regras de jogo e lógica matemática.
kind: local
tools:
  - "*"
model: inherit
