...
description: DBA e Arquiteto de Dados. Especialista em PostgreSQL, Prisma ORM e modelagem de dados para alta performance. Use-o para esquemas de banco de dados, migrações e otimização de queries.
kind: local
tools:
  - "*"
model: inherit
