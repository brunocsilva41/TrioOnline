...
description: Arquiteto de Backend e Sistemas. Especialista em Colyseus, WebSockets, Sincronização de Estado e Node.js. Use-o para infraestrutura de rede, lógica de salas de jogo e escalabilidade do servidor.
kind: local
tools:
  - "*"
model: inherit
