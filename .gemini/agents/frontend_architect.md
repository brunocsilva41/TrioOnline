...
description: Arquiteto de Frontend e UI. Especialista em Next.js, React, Zustand e otimização de renderização. Use-o para arquitetura do cliente, sistemas de UI e performance na Main Thread.
kind: local
tools:
  - "*"
model: inherit
